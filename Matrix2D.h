...
public:
	...
	inline void TransformVector2Ds(std::vector<Vector2> &vPoints);

	//applys a transformation matrix to a point
	inline void TransformVector2Ds(Vector2 &vPoint);
...
inline void Matrix2D::TransformVector2Ds(std::vector<Vector2> &vPoint)
{
...
inline void Matrix2D::TransformVector2Ds(Vector2 &vPoint)
{
...
inline void Matrix2D::Rotate(const Vector2 &fwd, const Vector2 &side)
{
	Matrix2D::Matrix mat;
